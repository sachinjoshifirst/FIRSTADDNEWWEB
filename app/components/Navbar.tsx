...
export default function Navbar({ openClaimModal,openRenewModal  }: NavbarProps) {
  ...
  return (
    <header className="gradient-bg sticky top-0 z-50 flex justify-between items-center px-8 py-5 backdrop-blur-md">
      ...
      >
        ...
        {/* Advisors */}
        <Link href="/advisors" className="hover:text-blue-600 font-medium">
          Insurance Advisors
        </Link>

        

        {/* Raise Claim Modal Button */}
        <button
